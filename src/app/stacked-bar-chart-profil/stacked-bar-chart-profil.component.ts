...
@Component({
  selector: 'app-stacked-bar-chart-profil',
  templateUrl: './stacked-bar-chart-profil.component.html',
  styleUrls: ['./stacked-bar-chart-profil.component.css']
})
export class StackedBarChartProfilComponent implements OnInit {
  fileName: string = '';
  fileContent: string = '';
  errorMessage: string = '';
  chart!: Chart;
